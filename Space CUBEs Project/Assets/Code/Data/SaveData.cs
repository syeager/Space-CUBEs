...
namespace LittleByte.Data
{
    ...
    public static class SaveData
    {
        ...
        private const string FilePostfix = ".dat";
        ...
        private static bool GetFileStream(string path, string file, out FileStream fileStream)
        {
            ...
            else if (!File.Exists(path + file + FilePostfix))
            {
                found = false;
            }

            fileStream = new FileStream(path + file + FilePostfix, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite, 8, FileOptions.RandomAccess);
            return found;
        }
