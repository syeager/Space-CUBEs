...
public class GameStart : Singleton<GameStart>
{
    ...
    public static readonly Dictionary<string, string> DevBuilds = new Dictionary<string, string>
    {
        ...
        {
            "Berserker",
            "Beserker|35|71|58|22|44/(4.0, 5.0, 5.0)/(0.0, 0.0, 0.0)/-1/-1/13~3~|38/(6.0, 4.0, 3.0)/(0.0, 0.0, 0.0)/-1/-1/13~|38/(3.0, 4.0, 3.0)/(0.0, 0.0, 180.0)/-1/-1/13~|100/(3.0, 3.0, 4.0)/(0.0, 0.0, 180.0)/0/-1/29~7~|103/(5.0, 4.0, 5.0)/(0.0, 0.0, 180.0)/1/-1/25~30~21~|106/(5.0, 6.0, 4.0)/(0.0, 0.0, 90.0)/2/-1/11~|102/(6.0, 3.0, 3.0)/(0.0, 0.0, 180.0)/3/-1/29~7~|107/(5.0, 4.0, 2.0)/(0.0, 180.0, 0.0)/-1/0/29~7~|109/(3.0, 3.0, 3.0)/(0.0, 180.0, 180.0)/-1/1/29~7~|112/(4.0, 5.0, 4.0)/(0.0, 270.0, 90.0)/-1/-1/29~|112/(5.0, 5.0, 4.0)/(0.0, 270.0, 90.0)/-1/-1/29~|111/(5.0, 4.0, 4.0)/(0.0, 0.0, 180.0)/-1/-1/29~|111/(5.0, 4.0, 3.0)/(0.0, 0.0, 180.0)/-1/-1/29~|111/(4.0, 4.0, 4.0)/(0.0, 0.0, 180.0)/-1/-1/29~|111/(4.0, 4.0, 3.0)/(0.0, 0.0, 180.0)/-1/-1/29~|12/(6.0, 5.0, 4.0)/(0.0, 0.0, 180.0)/-1/-1/27~21~|12/(3.0, 5.0, 4.0)/(0.0, 0.0, 180.0)/-1/-1/27~21~|46/(6.0, 5.0, 2.0)/(0.0, 0.0, 180.0)/-1/-1/22~27~|46/(3.0, 5.0, 2.0)/(0.0, 0.0, 180.0)/-1/-1/22~27~|46/(2.0, 3.0, 2.0)/(0.0, 0.0, 180.0)/-1/-1/13~27~|46/(7.0, 3.0, 2.0)/(0.0, 0.0, 180.0)/-1/-1/13~27~|8/(5.0, 3.0, 1.0)/(0.0, 0.0, 180.0)/-1/-1/22~29~|"
        },
    };
